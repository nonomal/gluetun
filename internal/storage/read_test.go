	...
	testCases := map[string]struct {
		...
		"different versions": {
			...
			hardcoded: models.AllServers{
				...
				Vpnsecure:      models.VpnsecureServers{Version: 1},
			...
			logged: []string{
				...
				"VPN Secure servers from file discarded because they have version 0 and hardcoded servers have version 1",
		...
		"same versions": {
			b: []byte(`{
				...
				"vpnsecure": {"version": 1, "timestamp": 1},
			...
			persisted: models.AllServers{
				...
				Vpnsecure:      models.VpnsecureServers{Version: 1, Timestamp: 1},
